...
class IntegrityChecker(object):
    ...
    def __init__(self, repo_path, log_file):
    ...
    def check_files(self):
        for root, dirs, files in sorted(os.walk(self.repo_path)):
...
def run_main():
    ...
    parser.add_argument(
        "repo_path", type=str, help="path to the Mbed TLS repository"
    )
    parser.add_argument(
    ...
    integrity_check = IntegrityChecker(
        check_args.repo_path, check_args.log_file
    )
